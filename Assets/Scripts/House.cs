...
namespace Assets.Scripts
{
    public class House : MonoBehaviour
    {
        ...
        void ComprarPeon()
        {
            ...
            var peon = Instantiate(peonPrefab, transform.position, Quaternion.identity);
            peon.GetComponent<Pawn>().InstanciarPeon(gameObject, manager, areaLimit);

            images[peonesActuales].GetComponent<SpriteRenderer>().sprite = peon.GetComponent<SpriteRenderer>().sprite; 
            peonesActuales++;
        }
